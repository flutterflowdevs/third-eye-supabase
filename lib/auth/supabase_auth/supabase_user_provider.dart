...
class ThirdEyeSupabaseSupabaseUser extends BaseAuthUser {
  ThirdEyeSupabaseSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> thirdEyeSupabaseSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = ThirdEyeSupabaseSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
