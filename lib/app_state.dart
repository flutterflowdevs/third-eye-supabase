...
class FFAppState extends ChangeNotifier {
  ...
  set audioFile(String value) {
    _audioFile = value;
  }

  dynamic _textToSpeechApiResp;
  dynamic get textToSpeechApiResp => _textToSpeechApiResp;
  set textToSpeechApiResp(dynamic value) {
    _textToSpeechApiResp = value;
  }

  String _textForAudio = '';
  String get textForAudio => _textForAudio;
  set textForAudio(String value) {
    _textForAudio = value;
  }
